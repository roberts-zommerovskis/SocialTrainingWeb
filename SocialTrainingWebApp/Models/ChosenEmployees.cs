...
namespace SocialTrainingWebApp.Models
{
    public class ChosenEmployees
    {
        ...
        public ChosenEmployees(Employee employeeToGuess, List<Employee> allEmployeeGuessingOptions)
        {
            ...
            //        .Where(x => x.employee.ImportId < 1007).ToList();
            ...
            //    string employeeToGuessSex = employeeToGuess.employee.Gender;
            ...
            //        .Where(wrapperElement => wrapperElement.employee.Gender == employeeToGuessSex)
            //        .ToList().Count > 0)
            //    {
            ...
            //            ||
            //            (db.Employee.ToList()[indexOfExtraChoice].Gender != employeeToGuessSex));
